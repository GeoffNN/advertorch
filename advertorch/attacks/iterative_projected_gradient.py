...
def perturb_russian_roulette(xvar, yvar, predict, stop_prob, eps, eps_iter, loss_fn,
                      delta_init=None, minimize=False, ord=np.inf,
                      clip_min=0.0, clip_max=1.0,
                      l1_sparsity=None):
    """
...
class PGDAttackRussianRoulette(Attack, LabelMixin):
    """
    ...
    def __init__(
            self, predict, loss_fn=None, eps=0.3, stop_prob=0.025,
            eps_iter=0.01, rand_init=True, clip_min=0., clip_max=1.,
            ord=np.inf, l1_sparsity=None, targeted=False):
        """
        Create an instance of the PGDAttack.
        """
        super(PGDAttackRussianRoulette, self).__init__(
    ...
    def perturb(self, x, y=None):
        ...
        rval = perturb_russian_roulette(
            x, y, self.predict, stop_prob=self.stop_prob,
